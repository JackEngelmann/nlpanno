...
# Class predictions are made by comparing the embedding of a sample to the class embeddings
# and calculating the similarity. The class predictions are saved in the database.
